...
pub fn main() !void {
...

    {
        ...
        }
        {
            ...
            //       verify them
            if (args.protocol_version < pulse.protocol_version) std.debug.panic("todo: not sure if we support server protocol version {}", .{pulse.protocol_version});
    ...
    {
        var cmd: [pulse.command.register_memfd_shmid]u8 = undefined;
